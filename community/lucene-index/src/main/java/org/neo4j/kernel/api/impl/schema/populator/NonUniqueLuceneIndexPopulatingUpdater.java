...
public class NonUniqueLuceneIndexPopulatingUpdater extends LuceneIndexPopulatingUpdater
{
    ...
    {
        String encodedValue = LuceneDocumentStructure.encodedStringValue( update.value() );
    ...
    {
        String encodedValueBefore = LuceneDocumentStructure.encodedStringValue( update.beforeValues() );
        sampler.exclude( encodedValueBefore );

        String encodedValueAfter = LuceneDocumentStructure.encodedStringValue( update.value() );
    ...
    {
        String removedValue = LuceneDocumentStructure.encodedStringValue( update.value() );
