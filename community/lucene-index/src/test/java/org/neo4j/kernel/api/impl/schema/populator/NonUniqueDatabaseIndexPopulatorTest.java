...
public class NonUniqueDatabaseIndexPopulatorTest
{
    ...
    public void sampleIncludedUpdates() throws Exception
    {
        ...
        List<IndexEntryUpdate> updates = Arrays.asList(
                IndexEntryUpdate.add( 1, descriptor, "aaa" ),
                IndexEntryUpdate.add( 2, descriptor, "bbb" ),
                IndexEntryUpdate.add( 3, descriptor, "ccc" ) );
    ...
    public void sampleIncludedUpdatesWithDuplicates() throws Exception
    {
        ...
        List<IndexEntryUpdate> updates = Arrays.asList(
                IndexEntryUpdate.add( 1, descriptor, "foo" ),
                IndexEntryUpdate.add( 2, descriptor, "bar" ),
                IndexEntryUpdate.add( 3, descriptor, "foo" ) );
    ...
    public void addUpdates() throws Exception
    {
        ...
        List<IndexEntryUpdate> updates = Arrays.asList(
                IndexEntryUpdate.add( 1, descriptor, "foo" ),
                IndexEntryUpdate.add( 2, descriptor, "bar" ),
                IndexEntryUpdate.add( 42, descriptor, "bar" ) );
