...
public class NativeLongSeekStoreTest
{
    ...
    private org.neo4j.kernel.impl.index.labelscan.NativeLongSeekStore store;
    ...
    public void before()
    {
        ...
        store = life.add( new org.neo4j.kernel.impl.index.labelscan.NativeLongSeekStore( pageCache, directory.absolutePath(),
