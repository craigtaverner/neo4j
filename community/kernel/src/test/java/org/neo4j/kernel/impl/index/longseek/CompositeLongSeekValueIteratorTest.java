...
public class CompositeLongSeekValueIteratorTest
{
    @Test
    public void mustHandleEmptyListOfIterators() throws Exception
    {
        ...
        // when
        CompositeLongSeekValueIterator
                iterator = new CompositeLongSeekValueIterator( iterators, false );
    ...
    public void mustOnlyReportValuesReportedByAll() throws Exception
    {
        ...
        // when
        CompositeLongSeekValueIterator
                iterator = new CompositeLongSeekValueIterator( iterators, true );
