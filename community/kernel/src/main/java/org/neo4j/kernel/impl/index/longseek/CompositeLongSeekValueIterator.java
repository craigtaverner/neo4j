...
class CompositeLongSeekValueIterator extends PrimitiveLongBaseIterator
{
    private final PriorityQueue<IdAndSource> sortedIterators = new PriorityQueue<>();
    private int atLeastNumberOfLabels;
    private long last = -1;

    CompositeLongSeekValueIterator( List<PrimitiveLongIterator> iterators, boolean trueForAll )
    {
