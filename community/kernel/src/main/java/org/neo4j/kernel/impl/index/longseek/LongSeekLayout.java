...
/**
 * {@link LongSeekKey} is used, but {@link LongSeekKey#idRange} is instead a range, 64 nodes in each
 */
public class LongSeekLayout implements Layout<LongSeekKey,LongSeekValue>
{
    ...
    public LongSeekLayout( int rangeSize )
    {
    ...
    @Override
    public int compare( LongSeekKey o1, LongSeekKey o2 )
    {
    ...
    @Override
    public LongSeekKey newKey()
    {
        return new LongSeekKey();
    }

    @Override
    public LongSeekKey copyKey( LongSeekKey key, LongSeekKey into )
    {
    ...
    @Override
    public LongSeekValue newValue()
    {
        return new LongSeekValue();
    }
    ...
    @Override
    public void writeKey( PageCursor cursor, LongSeekKey key )
    {
    ...
    @Override
    public void writeValue( PageCursor cursor, LongSeekValue value )
    {
        switch ( rangeSize )
        {
        case 8:
    ...
    @Override
    public void readKey( PageCursor cursor, LongSeekKey into )
    {
    ...
    @Override
    public void readValue( PageCursor cursor, LongSeekValue into )
    {
        switch ( rangeSize )
        {
        case 8:
