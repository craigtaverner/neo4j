...
public class SpatialIndexSettings implements LoadableConfig
{
    ...
    @Internal
    public static final Setting<Integer> spatial_crs_Cartesian_x_min = setting(
            "unsupported.dbms.db.spatial.crs.Cartesian.x.min", INTEGER, "-1000000" );
    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_Cartesian_x_max = setting(
            "unsupported.dbms.db.spatial.crs.Cartesian.x.max", INTEGER, "1000000" );
    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_Cartesian_y_min = setting(
            "unsupported.dbms.db.spatial.crs.Cartesian.y.min", INTEGER, "-1000000" );
    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_Cartesian_y_max = setting(
            "unsupported.dbms.db.spatial.crs.Cartesian.y.max", INTEGER, "1000000" );

    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_Cartesian_3D_x_min = setting(
            "unsupported.dbms.db.spatial.crs.Cartesian-3D.x.min", INTEGER, "-1000000" );
    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_Cartesian_3D_x_max = setting(
            "unsupported.dbms.db.spatial.crs.Cartesian-3D.x.max", INTEGER, "1000000" );
    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_Cartesian_3D_y_min = setting(
            "unsupported.dbms.db.spatial.crs.Cartesian-3D.y.min", INTEGER, "-1000000" );
    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_Cartesian_3D_y_max = setting(
            "unsupported.dbms.db.spatial.crs.Cartesian-3D.y.max", INTEGER, "1000000" );

    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_Cartesian_3D_z_min = setting(
            "unsupported.dbms.db.spatial.crs.Cartesian-3D.z.min", INTEGER, "-1000000" );
    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_Cartesian_3D_z_max = setting(
            "unsupported.dbms.db.spatial.crs.Cartesian-3D.z.max", INTEGER, "1000000" );

    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_WGS_84_x_min = setting(
            "unsupported.dbms.db.spatial.crs.WGS-84.x.min", INTEGER, "-180" );
    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_WGS_84_x_max = setting(
            "unsupported.dbms.db.spatial.crs.WGS-84.x.max", INTEGER, "180" );
    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_WGS_84_y_min = setting(
            "unsupported.dbms.db.spatial.crs.WGS-84.y.min", INTEGER, "-90" );
    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_WGS_84_y_max = setting(
            "unsupported.dbms.db.spatial.crs.WGS-84.y.max", INTEGER, "90" );

    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_WGS_84_3D_x_min = setting(
            "unsupported.dbms.db.spatial.crs.WGS-84-3D.x.min", INTEGER, "-180" );
    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_WGS_84_3D_x_max = setting(
            "unsupported.dbms.db.spatial.crs.WGS-84-3D.x.max", INTEGER, "180" );
    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_WGS_84_3D_y_min = setting(
            "unsupported.dbms.db.spatial.crs.WGS-84-3D.y.min", INTEGER, "-90" );
    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_WGS_84_3D_y_max = setting(
            "unsupported.dbms.db.spatial.crs.WGS-84-3D.y.max", INTEGER, "90" );

    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_WGS_84_3D_z_min = setting(
            "unsupported.dbms.db.spatial.crs.WGS-84-3D.z.min", INTEGER, "-1000000" );
    @Description("Index extents")
    @Internal
    public static final Setting<Integer> spatial_crs_WGS_84_3D_z_max = setting(
            "unsupported.dbms.db.spatial.crs.WGS-84-3D.z.max", INTEGER, "1000000" );
