...
class NativeLabelScanWriter implements LabelScanWriter
{
    ...
    private static final ValueMerger<LabelScanValue> ADD_AMENDER = (value,withValue) -> value.add( withValue );
    private static final ValueMerger<LabelScanValue> REMOVE_AMENDER = (value,withValue) -> value.remove( withValue );
