...
public class StartupConstraintSemanticsTest
{
    ...
    @Test
    public void shouldNotAllowOpeningADatabaseWithCompositeUniqueConstraintInCommunityEdition() throws Exception
    {
        assertThatCommunityCannotStartOnEnterpriseOnlyConstraint( "CREATE CONSTRAINT ON (n:Draconian) ASSERT (n.required,n.also) IS UNIQUE",
                StandardConstraintSemantics.ERROR_MESSAGE_COMPOSITE_UNIQUE );
    }
