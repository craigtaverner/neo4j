        ...
        extends AbstractConstraintCreationIT<UniquenessConstraint,NodePropertyDescriptor>
{
    ...
    public void shouldAbortConstraintCreationWhenDuplicatesExist() throws Exception
    {
        ...
        try
        {
            ...
            statement.uniquePropertyConstraintCreate( descriptor1 );
            ...
            throws Exception
    {
        ...
        {
            SchemaWriteOperations statement = schemaWriteOperationsInNewTransaction();
            constraint = statement.nodePropertyExistenceConstraintCreate( descriptor );
            commit();
        }
    ...
    public void committedConstraintRuleShouldCrossReferenceTheCorrespondingIndexRule() throws Exception
    {
        ...
        IndexRule indexRule = schema.indexRule( descriptor );
        UniquePropertyConstraintRule constraintRule = schema.uniquenessConstraint( descriptor );
